...
class LoggerService {
    ...
    private clc = {
        ...
        magenta: this.colorIfAllowed((text: string) => `\x1B[35m${text}\x1B[39m`),
        cyan: this.colorIfAllowed((text: string) => `\x1B[36m${text}\x1B[39m`),
        magentaBright: this.colorIfAllowed((text: string) => `\x1B[95m${text}\x1B[39m`),
        cyanBright: this.colorIfAllowed((text: string) => `\x1B[96m${text}\x1B[39m`),
    };
