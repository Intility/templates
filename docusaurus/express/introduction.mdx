...
* Node.js version > 14 installed. You can find the installer here: [Download | Node.js](https://nodejs.org/en/download/)
* Docker and Docker Compose, optional.
* Git

You'll also need to install [Yeoman](https://yeoman.io/) to install this template.

:::info Yeoman
Yeoman is a tool for scaffolding tool for generating new applications. Yeoman combines the powerful build configuration tool Gulp with npm for handling dependencies. 
:::
...
* Ready configured test environment using Jest 
