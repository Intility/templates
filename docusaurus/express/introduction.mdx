...
1. Run `git clone git@gitlab.intility.com:documentation/NodeTypeScriptProjectTemplate.git --depth 1`
...
1. Head to [https://gitlab.intility.com/documentation/NodeTypeScriptProjectTemplate](https://gitlab.intility.com/documentation/NodeTypeScriptProjectTemplate)
