...
To fix this, create an `.env` file by using the template provided in `.env.template` and setup authentication by following this ([Guide](./API/Azure/ApplicationRegistrations))
