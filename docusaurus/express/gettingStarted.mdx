...
3. **Automatic Git initialization** and push to given Git repository. - Please [create a GitLab](https://gitlab.intility.com/projects/new) project, and get the SSH key. - NOTE: Unselect the: 'Initialize repository with a README' under 'Project Configuration'
   :::
