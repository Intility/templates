...
slug: /API/Azure/ApplicationRegistrations
sidebar_position: 1
---
...
For more info about how to authorize users on your endpoints, head over to this guide: [Security | Authorization](../Security/Authorization.mdx).
