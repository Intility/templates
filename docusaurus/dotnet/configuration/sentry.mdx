...
In the code examples, copy the DSN value passed to `Sentry.Init`, and [add it to GitLab CI/CD variables](/dotnet/configuration/gitlab#adding-cicd-variables) with the key `SENTRY_DSN`.