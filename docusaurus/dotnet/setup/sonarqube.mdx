...
Yoy will have to replace badge image url using your sonarqube project name and desired badge type e.g `sonarqube-badge-proxy.apps.openshift.intility.com/badges/cool-portal/bugs`

The badge will be rendered in preview if configured correctly.


#### Optionally: embedding badges in readme

You can also embed badges in readme by using any of the following markdown syntaxes
    
*  `[![Description](proxy-badge-image-url)](url-to-your-project)`
    
*  `![Description](proxy-badge-image-url)`

Examples: 

* Badge linked to your project 
     [![Quality gate](https://sonarqube-badge-proxy.apps.openshift.intility.com/badges/flexview-functions/ncloc)](https://sonarqube.intility.no/dashboard?id=flexview-functions)

* Just badge
     ![Quality gate](https://sonarqube-badge-proxy.apps.openshift.intility.com/badges/flexview-functions/security)
