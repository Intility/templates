...
Select `Quality Gate Status`, and `Image URL only`. You can then use the Image URL and project dashboard URL to [create a badge in GitLab](/cra/configuration/gitlab#adding-badges).
