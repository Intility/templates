...
:::info
All production jobs is set to run on pushes to `master` or `main` branch.
:::
...
1. Create an app in your OpenShift project with the name `production`, unless it exists
