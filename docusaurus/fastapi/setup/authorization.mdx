...
should head over to the [official documentation](https://intility.github.io/fastapi-azure-auth/multi-tenant/azure_setup)
* `Redirect URI`: Leave blank.

Press **Register**

![1_application_registration](/img/fastapi/setup/single-tenant/1_application_registration.png)
...
![2_manifest](/img/fastapi/setup/single-tenant/2_manifest.png)


### Step 3 - Note down your application IDs
Go back to the `Overview`, found in the left menu.

Copy the `Application (Client) ID` place it in your `.env` file:
...
![3_overview](/img/fastapi/setup/single-tenant/3_overview.png)
...
![4_add_scope](/img/fastapi/setup/single-tenant/4_add_scope.png)
...
![5_add_scope_props](/img/fastapi/setup/single-tenant/5_add_scope_props.png)
...
![6_application_registration_openapi](/img/fastapi/setup/single-tenant/6_application_registration_openapi.png)
...
![3_manifest](/img/fastapi/setup/single-tenant/2_manifest.png)
...
![7_overview_openapi](/img/fastapi/setup/single-tenant/7_overview_openapi.png)
...
![8_api_permissions](/img/fastapi/setup/single-tenant/8_api_permissions.png)

Select the `user_impersonation` scope, and press **Add a permission**.

Your view should now look something like this:

![9_api_permissions_finish](/img/fastapi/setup/single-tenant/9_api_permissions_finish.png)

That's it! With these environment variables, FastAPI has been correctly configured from the template.


### Step 5 - Decide whether guest users should be allowed to access your application

**You will most likely want to deny guest users**, unless you have a very specific use case.
...
Alternatively, or in addition, you can do an in-code check by adding a dependency:
...
Read more about guest users [here](https://intility.github.io/fastapi-azure-auth/single-tenant/guest_users).