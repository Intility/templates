...
class Credentials(CustomBaseSettings):
    {% if cookiecutter.authentication_strategy == 'FastAPI Azure Auth (default)' %} # Azure
    ...
    {% endif %}
    {% if cookiecutter.sqlmodel == 'True' %} # Database
    ...
    {% endif %}{% if cookiecutter.authentication_strategy != 'FastAPI Azure Auth (default)' and cookiecutter.sqlmodel == 'False' %}
    ...{% endif %}
...
class SettingsWithDerivedValues(CustomBaseSettings):
    ...
    {% if cookiecutter.authentication_strategy != 'FastAPI Azure Auth (default)' and cookiecutter.sqlmodel == 'False' %}...{% endif %}
